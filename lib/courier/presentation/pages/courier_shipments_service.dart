...
class CourierShipmentsService {
  ...
  static Map<String, dynamic> _normalizeDetailJson(Map<String, dynamic> j) {
    ...
    // =========================
    // Koordinat tujuan (pembeli)
    // =========================
    out['buyer_lat'] ??= _pickNum(out, [
      'buyer_lat',
      'dest_lat',
      'destination_lat',
      'to_lat',
    ...
    out['pickup_address'] ??= _pickStr(out, [
      'pickup_address',
      'toko_address',
      'alamat_toko',
      'store_address',
